...
os.chdir(r"C:\Users\90538\Desktop\Miuul\PythonProgrammingForDataScience\data_analysis_with_python")
...
df = pd.read_csv(
    r"C:\Users\90538\Desktop\Miuul\PythonProgrammingForDataScience\data_analysis_with_python\datasets/advertising.csv")
df.head()
# pandas cheatsheet
...
df[(df["age"] > 50) & (df["sex"] == "male")][["age", "class"]].head()
...
pd.set_option('display.max_columns', None)
pd.set_option('display.width', 500)
df = pd.read_csv(r"C:\Users\90538\Desktop\Miuul\PythonProgrammingForDataScience\data_analysis_with_python\datasets/breast_cancer.csv")
df = df.iloc[:, 1:-1]
df.head()
df.info()
